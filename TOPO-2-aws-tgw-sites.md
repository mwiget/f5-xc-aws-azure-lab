...
marcel-aws-tgw-site-1:
       ...
       ------- Service VPC (10.64.0.0/20) ------   ------ Spoke VPC (10.0.0.0/20) ---------

       external       internal      workload       external      internal      workload
az1 10.64.0.0/24   10.64.1.0/24   10.64.2.0/24   10.0.0.0/24   10.0.1.0/24   10.0.2.0/24
az2 10.64.3.0/24   10.64.4.0/24   10.64.4.0/24   10.0.3.0/24   10.0.4.0/24   10.0.5.0/24
az3 10.64.6.0/24   10.64.7.0/24   10.64.7.0/24   10.0.6.0/24   10.0.7.0/24   10.0.8.0/24

marcel-aws-tgw-site-2: 

       ------- Service VPC (10.64.32.0/20) ------  ------ Spoke VPC (10.0.32.0/20) --------

       external       internal       workload      external      internal      workload
az1 10.64.32.0/24  10.64.33.0/24  10.64.34.0/24  10.0.32.0/24  10.0.33.0/24  10.0.34.0/24
az2 10.64.35.0/24  10.64.36.0/24  10.64.37.0/24  10.0.35.0/24  10.0.36.0/24  10.0.37.0/24
az3 10.64.38.0/24  10.64.39.0/24  10.64.40.0/24  10.0.38.0/24  10.0.39.0/24  10.0.40.0/24
```
...
PING 10.64.32.102 (10.64.32.102) 56(84) bytes of data.
64 bytes from 10.64.32.102: icmp_seq=1 ttl=64 time=0.119 ms
64 bytes from 10.64.32.102: icmp_seq=2 ttl=64 time=0.090 ms
64 bytes from 10.64.32.102: icmp_seq=3 ttl=64 time=0.085 ms

--- 10.64.32.102 ping statistics ---
3 packets transmitted, 3 received, 0% packet loss, time 408ms
rtt min/avg/max/mdev = 0.085/0.098/0.119/0.015 ms

PING 10.64.0.101 (10.64.0.101) 56(84) bytes of data.
64 bytes from 10.64.0.101: icmp_seq=1 ttl=64 time=0.137 ms
64 bytes from 10.64.0.101: icmp_seq=2 ttl=64 time=0.110 ms
64 bytes from 10.64.0.101: icmp_seq=3 ttl=64 time=0.084 ms

--- 10.64.0.101 ping statistics ---
...
$ ./list-sites.sh                   
marcel-aws-tgw-site-1:                                                
master-0        35.162.250.202  10.64.0.132                          
master-1        52.11.65.198    10.64.3.134                          
master-2        35.83.219.65    10.64.6.194                          

marcel-aws-tgw-site-2:                                                
master-0        44.230.239.119  10.64.32.220                         
master-1        52.35.236.45    10.64.35.51                          
master-2        54.218.28.252   10.64.38.160                         
```
...
```
$ ./list-bench.sh 
marcel-f5-xc-bench-1    18.236.49.37    10.64.0.101
marcel-f5-xc-bench-2    35.167.57.124   10.64.32.102
```
